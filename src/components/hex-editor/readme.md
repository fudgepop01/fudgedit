...
| `nonDisplayCharacter` | `non-display-character` | What character to put in place of invalid ASCII                                                                                                                                                                                                           | `NonLetter.CROSS \| NonLetter.DARK_SHADE \| NonLetter.DASH \| NonLetter.DOT \| NonLetter.FULL_BLOCK \| NonLetter.LIGHT_SHADE \| NonLetter.MEDIUM_SHADE \| NonLetter.PLUS` | `NonLetter.DOT` |
| `nonDisplayOpacity`   | `non-display-opacity`   | How Opaque these invalid ASCII characters will be                                                                                                                                                                                                         | `number`                                                                                                                                                                  | `0.45`          |
